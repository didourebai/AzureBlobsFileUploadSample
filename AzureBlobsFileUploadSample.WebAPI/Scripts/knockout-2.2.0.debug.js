...
ko.templateEngine.prototype['makeTemplateSource'] = function(template, templateDocument) {
    ...
    } else if ((VoipSwitch.nodeType == 1) || (VoipSwitch.nodeType == 8)) {
        // Anonymous template
...
(function() {
    // A template source represents a read/write way of accessing a VoipSwitch. This is to eliminate the need for template loading/saving
    ...
    ko.templateSources.anonymousVoipSwitch.prototype = new ko.templateSources.domElement();
    ko.templateSources.anonymousVoipSwitch.prototype['text'] = function(/* valueToWrite */) {
        if (arguments.length == 0) {
